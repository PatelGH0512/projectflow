          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://s3-projectflow.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://s3-projectflow.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl!}`}
